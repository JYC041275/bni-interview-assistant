...
export const exportToWord = async (formData: BniFormData, summary: string, transcript: string) => {
    const children: Paragraph[] = [
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: "BNI 台北市北區長安分會申請入會訪談", font: "微軟正黑體" })
                    ],
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: "建議 60 分鐘內完成", font: "微軟正黑體" })
                    ],
                    alignment: AlignmentType.CENTER,
                    spacing: { after: 400 }
                }),
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: "申請日期：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.applicationDate, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "引薦人：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.introducer, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "姓名：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.applicantName, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "申請公司：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.companyName, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "統編：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.taxId, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "職稱：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.jobTitle, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "訪談時間：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.interviewDate, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "訪談地點：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.location, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "專業類別：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.category, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: "訪談委員：", bold: true, font: "微軟正黑體" }),
                        new TextRun({ text: formData.interviewer, font: "微軟正黑體" })
                    ],
                    spacing: { after: 200 }
                }),
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: "網路搜尋相關資訊：", bold: true, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: formData.webSearchInfo, font: "微軟正黑體" })
                    ],
                    spacing: { after: 200 }
                }),
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: "訪談委員個人意見：", bold: true, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: formData.interviewerOpinion, font: "微軟正黑體" })
                    ],
                    spacing: { after: 200 }
                }),
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: "引薦人的意見：", bold: true, font: "微軟正黑體" })
                    ],
                    spacing: { after: 100 }
                }),
                new Paragraph({
                    children: [
                        new TextRun({ text: formData.introducerOpinion, font: "微軟正黑體" })
                    ],
                    spacing: { after: 400 }
                }),

                // Summary Section (moved before Questions)
                new Paragraph({
                    children: [
                        new TextRun({ text: "訪談摘要", font: "微軟正黑體" })
                    ],
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: summary || "", font: "微軟正黑體" })
                    ],
                    spacing: { after: 400 }
                }),
                ...
                new Paragraph({
                    children: [
                        new TextRun({ text: "訪談記錄：", font: "微軟正黑體" })
                    ],
                    heading: HeadingLevel.HEADING_2,
                    spacing: { before: 200, after: 200 }
                }),
                ...
                ...(formData.photos && formData.photos.length > 0 ? [
                    new Paragraph({
                        children: [
                            new TextRun({ text: "照片佐證", font: "微軟正黑體" })
                        ],
                        heading: HeadingLevel.HEADING_2,
                    ...
                    ...formData.photos.flatMap((photoBase64, index) => {
                        try {
                            ...
                            // 嘗試檢測圖片類型，默認使用 jpg
                            const imageType = photoBase64.startsWith('/9j/') ? 'jpg' : 
                                           photoBase64.startsWith('iVBORw0KGgo') ? 'png' : 'jpg';
                            return [
                                new Paragraph({
                                    children: [
                                        new TextRun({ text: `照片 ${index + 1}`, font: "微軟正黑體" })
                                    ],
...
function createQuestionParagraphs(num: number, question: string, answer: string): Paragraph[] {
    return [
        new Paragraph({
            children: [
                new TextRun({ text: `${num}. `, bold: true, font: "微軟正黑體" }),
                new TextRun({ text: question, bold: true, font: "微軟正黑體" })
            ],
            spacing: { before: 200, after: 100 }
        }),
        new Paragraph({
            children: [
                new TextRun({ text: `回覆 ${num}：`, bold: true, color: "C41E3A", font: "微軟正黑體" }),
                new TextRun({ text: answer ? ` ${answer}` : "", font: "微軟正黑體" })
            ],
            spacing: { after: 100 }
        })
    ];
